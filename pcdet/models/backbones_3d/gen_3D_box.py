...
waymo2_com3_kitti_nov4 = {1: [3.95169492, 1.61813559, 1.5379661 ], # Car
	2: [0.7208, 0.6348, 1.732],                # Pedestrian
	3: [8.255,      2.53333333, 3.35333333],   # Truck
	8: [5.348, 1.946, 2.326],                 # Van
	9: [1.008, 0.59,  1.264 ],                # Person_sitting
	10: [1.964, 0.588, 1.768],                 # Cyclist
	11: [14.202,  2.292,  3.568],              # Tram
}

# # 'Car', 'Pedestrian', 'Truck',  'Van', 'Person_sitting', 'Cyclist', 'Tram', 'Bicycle', 'UtilityVehicle', 'Bus'
# kitti_com3_a2d2_nov3 = {
#     1: [3.99, 1.99, 1.72 ],      # Car
# 	2: [1.00,  0.81, 1.81],      # Pedestrian
# 	3: [9.44,  3.10, 3.82],      # Truck
# 	8: [1.93,  0.82, 1.70],      # Bicycle
# 	9: [10.20, 3.41, 4.68],      # UtilityVehicle
# 	10: [7.85,  2.89, 3.04],     # Bus
# }
...
init_loc_waymo2_com3_kitti_nov4 = {
    1: 'origin', # Car
	2: 'obj_center',                # Pedestrian
	3: 'origin',   # Truck
	8: 'origin',                 # Van
	9: 'obj_center',                # Person_sitting
	10: 'obj_center',                 # Cyclist
	11: 'origin',              # Tram
}
...
loss_cal_waymo2_com3_kitti_nov4 = {
    1: 'add', # Car
	2: 'add',                # Pedestrian
	3: 'add',               # Truck
	8: 'add',                 # Van
	9: 'add',                # Person_sitting
	10: 'add',                 # Cyclist
	11: 'origin',              # Tram
}
            ...
            def objective(params):
                ...
                if loss_cal[box_fit_config][label] == 'add':
                    if init_loc[box_fit_config][label] == 'obj_center':
                        ...
                        total_distance += 0.5*close_boundary
