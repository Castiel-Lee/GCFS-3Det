...
class VoxelBackBone8x_ImgGDinoSam_2(nn.Module):
    ...
    def gen_img_seg_feat_2D(self, image_cur, boxes=None, labels=None, score_rois=None):
        ...
        if use_gdino_box:
            ...
            boxes_first, logits_first, phrases_first = remove_overlap_boxes(boxes_first, logits_first, phrases_first)
            ...
            boxes_second, logits_second, phrases_second = remove_overlap_boxes(boxes_second, logits_second, phrases_second)
