...
class PVRCNN_AE_TestTimeTraining(Detector3DTemplate_DG_2_Source_Domain):
    ...
    def forward(self, batch_dict):
        ...
        if self.training:
            ...
            batch_dict_org = {
                ...
                'voxels': batch_dict['voxels_org'],
                'voxel_coords': batch_dict['voxel_coords_org'],
                'voxel_num_points': batch_dict['voxel_num_points_org'],
            }
