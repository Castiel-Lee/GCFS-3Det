...
def get_voxel_centers(voxel_coords, downsample_times, voxel_size, point_cloud_range):
    ...
    if isinstance(downsample_times, int):
        voxel_size = torch.tensor(voxel_size, device=voxel_centers.device).float() * downsample_times
    elif isinstance(downsample_times, list):
        voxel_size = torch.tensor(voxel_size, device=voxel_centers.device).float() * torch.tensor(downsample_times, device=voxel_centers.device).float()
