...
from .sampler_custom import Sampler_CL, BatchSampler_CL
...
def build_dataloader(dataset_cfg, class_names, batch_size, dist, root_path=None, workers=4,
                     ...
                     shuffle_sample_training=True, extra_samples_per_batch=None, drop_last=False):
    ...
    if training and (extra_samples_per_batch is not None):
        sampler_cl = Sampler_CL(dataset=dataset, basic_size=dataset.__len__())
        batch_sampler_cl = BatchSampler_CL(
            sampler=sampler_cl, 
            batch_size=batch_size, 
            basic_size=dataset.__len__(), 
            extra_batch_size=extra_samples_per_batch,
        )
        dataloader = DataLoader(
            dataset, pin_memory=True, num_workers=workers,
            collate_fn=dataset.collate_batch,
            timeout=0,
            batch_sampler=batch_sampler_cl
        )
    else:
        dataloader = DataLoader(
