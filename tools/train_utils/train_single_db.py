...
def train_one_epoch(model, optimizer, train_loader, model_func, lr_scheduler, accumulated_iter, optim_cfg,
    ...
    for cur_it in range(total_it_each_epoch):
        ...
        #     # if name == 'dense_head.heads_list.3.hm.0.0.weight': 
        #     if name == 'roi_head.roi_grid_pool_layers.0.mlps_pos.0.1.weight': 
        #         print(param.sum())

        # import torch.nn as nn
        # for name, module in model.named_modules():
        #     if "backbone_3d.conv2.0" in name and isinstance(module, nn.BatchNorm1d):  # Adjust for 1D if needed
        #         print(name, module.training, module.running_var)
