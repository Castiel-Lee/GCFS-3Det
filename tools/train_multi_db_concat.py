...
from train_utils.train_single_db import train_model
from train_utils.train_2_datasets_in_parallel_utils import train_multi_db_model
...
def main():
    ...
    if cfg.get('TRAIN_DB_IN_PARALLEL', None):
    ...
    if cfg.get('TRAIN_DB_IN_PARALLEL', None):
        train_func(
            ...
            source_sampler_2=source_sampler_2,
